...
class MyVentana(Frame):
    ...
    def create_widgets(self):
        self.lblNum1 = Label(self, text="Primer numero", bg="yellow")
        self.txtNum1 = Entry(self, bg="pink")
        self.lblNum2 = Label(self, text="Segundo numero", bg="yellow")
        ...
        self.lblNum2.place(x=10,y=50, width=110, height=30)
